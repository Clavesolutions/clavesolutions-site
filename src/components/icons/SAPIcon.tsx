export default function SAPIcon({ className }: { className?: string }) {
  return (
    <svg 
    ...
    >
      <defs>
        <linearGradient id="sap-linear-gradient" x1="206.19" y1="0" x2="206.19" y2="204" gradientUnits="userSpaceOnUse">
